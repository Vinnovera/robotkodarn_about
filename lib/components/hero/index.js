    ...
    return html`
      <section class="${renderStyle(type)}">
        <div class="u-widthL">
          ...
          <p class="u-textM u-textWeightL u-lineHeightM">${doc.data.introduction}</p>
          <a href="${doc.data.link.url}" class="Button u-textM">${doc.data.link_title}</a>
        </div>
        ${pattern(type)}
      </section>
      `
    ...
    return html`
      <section class="${renderStyle(type)}">
        <div class="Hero-content">
          ${heading(doc.data.title)}
          <p class="u-textWeightM u-lineHeightL u-textM u-marginBottomL">${doc.data.introduction}</p>
