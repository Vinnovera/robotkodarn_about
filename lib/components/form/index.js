...
/**
 * Handles feedback message to user.
 */
const feedback = (error, fade, status) => {
  ...
  let content = __('You are now subscribing.')

  if (error) {
    /**
     * Status is provided by Mailchimp. If member already exists,
     * give specific informatio about this. Else, just give
     * general error information.
     */
    content = status === 'Member Exists'
      ? __('E-mail address is already registered.')
