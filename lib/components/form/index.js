  ...
  return html`
    <section class="Form">
      <div class="Form-content">
        ...
        <form class="Form-aside" action="${process.env.MAILCHIMP_ENDPOINT}" method="POST">
          ...
          <label class="u-textXS u-fontFamilySans u-marginBottomS u-textWeightL" for="MERGE0">${__('Email')}</label>
            <input class="Input" type="email" name="MERGE0" id="MERGE0" size="25" placeholder="${__('example@address.com')}">
