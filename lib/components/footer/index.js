            ...
            case 'company_address': return html`
              <address class="Footer-address">
                <p class="u-textS u-fontFamilySans">
                  ...
                  ${__('Phone')}: <a class="Footer-link u-marginTopM u-inlineBlock" href="tel:${convertToTel(slice.primary.phone)}">${slice.primary.phone}</a><br>
                  ${__('Email')}: <a class="Footer-link Footer-link--expressive" href="${slice.primary.email.url}">${trim(slice.primary.email.url)}</a>
                </p>
              </address>
            `
            default: return null
