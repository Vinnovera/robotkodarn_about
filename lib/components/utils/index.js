...
exports.renderImage = (image, style) => {
  return html`
    <img class="${style}-image" src="${image.md_800.url}" alt="${image.alt}" srcset="${image.url} 300w, ${image.sm_600.url} 600w, ${image.md_800.url} 800w, ${image.lg_1600.url} 1600w, ${image.xl_2400.url} 2400w" sizes="(min-width: 800px) 800px" />
  `
}
