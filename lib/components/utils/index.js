...
exports.serialize = className => (element, content, children) => {
  ...
  switch (element.type) {
    case Elements.heading1: return html`<h1 class="${className}-heading">${children}</h1>`
    case Elements.heading2: return html`<h2 class="${className}-heading2">${children}</h2>`
    case Elements.heading3: return html`<h3 class="${className}-heading3">${children}</h3>`
    case Elements.hyperlink: return html`<a class="${className}-link">${children}</a>`
    case Elements.paragraph: return html`<p class="${className}-paragraph">${children}</p>`
    case Elements.em: return html`<em class="${className}-quote">${children}</p>`
    default: return null
  }
}
