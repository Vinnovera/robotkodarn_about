...
function section (state = {}, emit, slice, page, type = 'text') {
  ...
  const implodeSection = event => {
    ...
    const onanimationend = (event) => {
      ...
      /**
       * Use 'scrollIntoView' to scroll back to the title of the section that
       * was expanded. This is a sibling to the container
       * that is being imploded.
       */
      container.previousElementSibling.scrollIntoView({ block: 'start', behavior: 'smooth' })
