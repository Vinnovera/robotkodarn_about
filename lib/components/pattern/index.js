...
/*
 * Pattern used in Hero component. It is created by Nicky Knicky
 * and is published under CC license by the Noun project. It is found here:
 * https://thenounproject.com/term/bowie/871160/
 *
 * Transform attribute is needed directly in svg element due to bug in IE11:
 * https://connect.microsoft.com/IE/feedback/details/811744/
 * ie11-bug-with-implementation-of-css-transforms-in-svg
 *
 * `xlink:href` is deprecated since SVG 2, but needed since Safari is using
 * SVG 1.1 which does not yet support using `href`.
