...
function pattern (color) {
  return html`
    <svg class="${modifiers('Pattern', { [color]: true })}" viewBox="0 0 730 620" preserveAspectRatio="xMidYMid slice">
    <defs>
...
function triangles () {
  return html`
    <svg class="${modifiers('Pattern', { mauve: true })}" viewBox="0 0 1200 500" preserveAspectRatio="xMidYMid slice">
      <defs>
        <symbol id="three">
